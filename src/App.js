      ...
      {isModalOpen && (
        <div className="modal" onClick={closeModal}>
          <div className="modal-content" style={{backgroundColor:'rgb(0,0,0,.8)', borderRadius:'5px', height:'355px', overflow:'scroll'}} onClick={(e) => e.stopPropagation()}>
            ...
            <p style={{fontFamily:'cursive', textDecoration:'none', color:'greenyellow', fontWeight:'normal'}}>❤️<br /> They found each other<span style={{fontFamily:'cursive', textDecoration:'none'}}><br /> </span>  ❤️❤️❤️ <hr /> </p>
